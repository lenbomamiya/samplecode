...
<body>
	...
	<table border="0" width="1000" align="center">
		<tr>
            ...
            <td align="left" width="43%" nowrap><font size="6"><a href="bulletin.php" target="_self">教室借用查詢系統</a></font><br></td>
        </tr>
    	<tr>
        	<td align="center" colspan="2">
    			<form method="post" action="bulletin.php">
					...
					<!-- &nbsp;<input type="button" value="預設查詢" echo onClick="location.href='bulletin.php'"/> -->
					&nbsp;<input type="button" value="階梯教室借用情形" echo onClick="window.open('http://www.ga.ntnu.edu.tw:81/Eclass/HTML/web/rent01.html')"/>
    			</form>
    			<hr width="100%">
    		</td>
        </tr>
    ...
    <?php if(!$RecordsTotal){ ?>
		<table border="0" width="899" align="center"><tr><td align="center">
	...
	<?php }else{ ?>
		...
		<table border="0" cellspacing="2" width="899" align="center">
        ...
        <table border="0" cellspacing="2" width="899" align="center"><tr>
  			<td align="right" width="60" nowrap>頁數：</td>
  			<td align="left" width="531" nowrap>
  				...
  				<?php
  					for($i=1;$i<=$PagesTotal;$i++){
  	  					if($i==$PageNum){
  	  						...
  	  						echo "<a href=\"bulletin.php?Pages=$i\">$i</a> ";
  						}
  					}
  				?>
  			   	<!-- pages function end -->
    		...
    		<td align="right" width="300" nowrap>
    			...
    			<?php if ($PageNum > 1) { // If it not first page, then print the message below. ?>
    				<a href="bulletin.php?Pages=1">第一頁</a>&nbsp;
    				<a href="bulletin.php?Pages=<?php echo $PageNum-1;?>">上一頁</a>&nbsp;
    			<?php } ?>
    			<?php if ($PageNum < $PagesTotal) { // If it not last page, then print the message below. ?>
    				<a href="bulletin.php?Pages=<?php echo $PageNum+1;?>">下一頁</a>&nbsp;
    				<a href="bulletin.php?Pages=<?php echo $PagesTotal;?>">最後頁</a>&nbsp;
    			<?php } ?>
    			<!-- volti function end -->
  			</td>
  		</tr></table>
